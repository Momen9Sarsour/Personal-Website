                    ...
                    <div class="text-center text-xxl-start">
                        ...
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                            <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder"
                                href="{{ route('front.resume') }}">Resume</a>
                            <a class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder"
                                href="{{ route('front.projects') }}">Projects</a>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-7">
                ...
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        ...
                        <div class="d-flex justify-content-center fs-2 gap-4">
                            ...
                            @if ($settings['twitter'])
                                <a class="text-gradient" target="_blank" href="{{ $settings['twitter'] }}"><i
                                        class="bi bi-twitter"></i></a>
                            @endif
                            @if ($settings['facebook'])
                                <a class="text-gradient" target="_blank" href="{{ $settings['facebook'] }}"><i
                                        class="bi bi-facebook"></i></a>
                            @endif
                            @if ($settings['linkedin'])
                                <a class="text-gradient" target="_blank" href="{{ $settings['linkedin'] }}"><i
                                        class="bi bi-linkedin"></i></a>
                            @endif
                            @if ($settings['github'])
                                <a class="text-gradient" target="_blank" href="{{ $settings['github'] }}"><i
