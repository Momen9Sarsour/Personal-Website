...
@section('title', 'Resume | ' . env('APP_NAME'))
            ...
            <div class="col-lg-11 col-xl-9 col-xxl-8">
                ...
                <section>
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a class="btn btn-primary px-4 py-3" onclick="window.print()">
                        ...
                        <div class="card shadow border-0 rounded-4 mb-5">
                            <div class="card-body p-5">
                                <div class="row align-items-center gx-5">
                                    <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                        <div class="bg-light p-4 rounded-4">
                                            <div class="text-primary fw-bolder mb-2">
                                                {{ Carbon::make($experience->start_date)->format('y-m') }} /
                                                {{ Carbon::make($experience->end_date)->format('y-m') }}</div>
                                    ...
                                    <div class="col-lg-8">{{ $experience->description }}</div>
                                </div>
                            </div>
                        </div>
                    @endforeach
                                    ...
                                    <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                        <div class="bg-light p-4 rounded-4">
                                            <div class="text-secondary fw-bolder mb-2">
                                                {{ Carbon::make($education->start_date)->format('y-m') }} /
                                                {{ Carbon::make($education->end_date)->format('y-m') }}</div>
                                            <div class="mb-2">
                                                <div class="small fw-bolder">{{ $education->collage }}</div>
