                ...
                <div class="col-lg-11 col-xl-9 col-xxl-8">
                    @foreach ($projects as $project)
                        ...
                        <a href="{{$project->link}}" target="_blank" style="color: inherit; text-decoration: none"
                            class="card overflow-hidden shadow rounded-4 border-0 mb-5" onclick="{{ !$project->link ? 'event.preventDefault()' : '' }}">
                            <div class="card-body p-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <img class="img-fluid w-50" src="{{ asset($project->image) }}" alt="..." />
                                </div>
                            </div>
                        </a>
                    @endforeach
